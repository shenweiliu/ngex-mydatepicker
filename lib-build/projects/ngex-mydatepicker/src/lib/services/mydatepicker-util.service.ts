...
export class UtilService {
    ...
    isDisabledDate(date: IMyDate, options: IMyOptions): IMyDisabledDate {
        ...
        const result = inputDates.find((d: any) => {
            return d.dates;
        });
    ...
    //SW 1/26/2025 updated definition defaults.
    getDateModel(date?: IMyDate, dateRange?: IMyDateRange, dateFormat?: string, monthLabels?: IMyMonthLabels, rangeDelimiter?: string, dateStr: string = EMPTY_STR): IMyDateModel {
        let singleDateModel: IMySingleDateModel | null = null;
        let dateRangeModel: IMyDateRangeModel | null = null;
    ...
    getKeyCodeFromEvent(event: any): number | null {
