...
export interface IMyOptions {
  ...
  //minYear?: Year;  
  //maxYear?: Year; 
  minYear?: number; //SW 1/25/2026: this should be number, not the enum 
  maxYear?: number; //SW 1/25/2026: this should be number, not the enum 
  ...
  //SW 1/26/2025 add indexable key signatures called from angular-mydatepicker.input.ts.
  [key: string]: undefined | string | number | boolean | IMyDayLabels | IMyMonthLabels | IMyDate | Array<IMyDate>
  | Array<IMyDisabledDates> | Array<IMyDateRange> | Array<string> | IMyMarkedDate | Array<IMyMarkedDates> 
  | IMyCalendarAnimation | IMyStyles | IMyDivHostElement;
